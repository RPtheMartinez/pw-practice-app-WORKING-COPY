// Copy of autoWaiting.spec.ts
import { test, expect } from '@playwright/test'

test.describe.skip('Skip all tests in this file', () => {
  ...
  test.skip('Autowaiting Test Example 1', async ({page}) => {
  ...
  test.skip('Alternative Waits Test Examples', async ({page}) => {
    const successButton = page.locator('bg-success')
